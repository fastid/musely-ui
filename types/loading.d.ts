/*
 * @Author: Victor wang
 * @Date: 2020-06-21 14:40:52
 * @LastEditors: Victor.wang
 * @LastEditTime: 2020-06-21 14:41:49
 * @Description:
 */
...
/** Loading Component */
export declare class MuLoadingComponent extends Vue {
  /** Close the Loading instance */
  close(): void
}

/** Loading directive definition */
export interface MuLoadingDirective extends VNodeDirective {
  name: 'loading'
  value: boolean
  modifiers: {
    body: boolean
...
export interface MuLoading {
  ...
  service(options: LoadingServiceOptions): MuLoadingComponent
...
declare module 'vue/types/vue' {
  interface Vue {
    /** If you do not have a specific DOM node to attach the Loading directive, or if you simply prefer not to use Loading as a directive, you can call this service with some configs to open a Loading instance. */
    $loading(options: LoadingServiceOptions): MuLoadingComponent
  }
}
